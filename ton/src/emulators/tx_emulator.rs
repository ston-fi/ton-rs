...
mod tests {
    ...
    static TEST_SHARD_ACCOUNT: LazyLock<ShardAccount> = LazyLock::new(|| {
    ...
    static TEST_MSG_IN_EXT: LazyLock<Msg> = LazyLock::new(|| {
        Msg::from_boc_hex(
    ...
    static TEST_RAND_SEED: LazyLock<TonHash> = LazyLock::new(|| {
