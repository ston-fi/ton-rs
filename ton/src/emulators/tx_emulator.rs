...
mod tests {
    ...
    static TEST_EXPECTED_SHARD_ACCOUNT: LazyLock<ShardAccount> = LazyLock::new(|| {
        ShardAccount::from_boc_hex(""
            ).unwrap()
    });
    pub static TEST_RAND_SEED: LazyLock<TonHash> = LazyLock::new(|| {
        TonHash::from_str("14857b338a5bf80a4c87e726846672173bb780f694c96c15084a3cbcc719ebf0").unwrap()
    });
    ...
    pub(crate) static TEST_MSG_IN_EXT: LazyLock<Msg> = LazyLock::new(|| {
        Msg::from_boc_hex(
    ...
    #[test]
    fn test_tx_emulator_emulate_serialize() -> anyhow::Result<()> {
        sys_tonlib_set_verbosity_level(0);
        let mut emulator = TXEmulator::new(0, false)?;
        let shard_account = TEST_SHARD_ACCOUNT.clone();
    ...
    fn test_tx_emulator_no_libs() -> anyhow::Result<()> {
        ...
        let _emulator = assert_ok!(TXEmulator::new(0, false));

        let _dumped_args = assert_ok!(std::fs::read(EMUL_ARGS_TEST_PATH));
