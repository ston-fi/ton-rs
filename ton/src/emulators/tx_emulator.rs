...
mod tests {
    ...
    fn test_tx_emulator_emulate_ext_in_wallet() -> anyhow::Result<()> {
        ...
        let mut ord_args =
            create_test_tx_emul_ord_args(ext_in_msg, &shard_account, &BC_CONFIG, DEFAULT_UTIME, DEFAULT_LOGIC_TIME)?;
        ...
        let expected_shard_account = ShardAccount::from_boc_hex(
            "",
        )?;
    ...
    #[test]
    fn test_tx_emulator_emulate_seriallize() -> anyhow::Result<()> {
        sys_tonlib_set_verbosity_level(0);
        let mut emulator = TXEmulator::new(0, false)?;
