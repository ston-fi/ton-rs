...
pub(super) fn validate_msgs_count(msgs: &[TonCell], msgs_modes: &[u8], max_cnt: usize) -> Result<(), TonCoreError> {
...
pub(super) fn parse_inner_request(request: InnerRequest) -> Result<(Vec<TonCell>, Vec<u8>), TonCoreError> {
...
pub(super) fn build_inner_request(msgs: &[TonCell], msgs_modes: &[u8]) -> Result<InnerRequest, TonCoreError> {
    if msgs.is_empty() {
